    ...
    public class PoseEditorManager : MonoBehaviour
    {
        ...
        public void DrawHandle(bool colorize = true)
        {
            ...
            for (var i = 0; i < bones.Length; i++)
            {
                ...
                var fmh_432_59_638722081670223360 = bones[i].rotation; Handles.FreeMoveHandle(bones[i].position, handleSize * worldSize * handle.handleScale, Vector3.zero, Handles.SphereHandleCap);
